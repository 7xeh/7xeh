...
<p align="center">
  <sub>I build practical, small projects that solve specific annoyances.</sub>
</p>
...
| :--- | :--- | :--- | :--- |
| [**Spicy Lyric Translate**](https://github.com/7xeh/SpicyLyricTranslate) | Spotify Extension | ![Stars](https://img.shields.io/github/stars/7xeh/SpicyLyricTranslate?style=flat-square&color=1DB954) | <!-- COMMIT:SpicyLyricTranslate -->`2026-01-30` Update main entry point in manifest.json<!-- /COMMIT --> |
